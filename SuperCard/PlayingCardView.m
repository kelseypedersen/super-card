...
// For all setters, also saying if the suit, rank or faceup changes, display eneds to be re-drawn
...
- (void)drawRect:(CGRect)rect {
    ...
    // keeps the white within the card
    [roundedRect addClip];
    ...
    [roundedRect stroke];
    NSLog(@"before %@%@", [self rankAsString], self.suit);
